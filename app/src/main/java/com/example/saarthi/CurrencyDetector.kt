...
class CurrencyDetector(private val context: Context) {
    ...
    private fun updateModelInputDimensions() {
        interpreter?.let { interp ->
            try {
                ...
                Log.e("CurrencyDetector", "Error updating model dimensions: ${e.message}")
            }
        }
    }
    ...
    private fun convertBitmapToByteBuffer(bitmap: Bitmap): ByteBuffer {
        ...
        Log.d("CurrencyDetector", "Creating buffer of size: $inputSize bytes for ${modelInputWidth}x${modelInputHeight} image with $numChannels channels")
        ...
        Log.d("CurrencyDetector", "ByteBuffer position after filling: ${byteBuffer.position()}, Expected: $inputSize")
        byteBuffer.rewind()
        return byteBuffer
    }
    ...
    private fun loadLabels() {
        try {
            ...
            labels = listOf("none", "5", "10", "20", "50", "100", "200", "500", "2000") // Fallback
        }
    }
